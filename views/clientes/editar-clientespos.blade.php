...
<div class="row">
 ...
 <ul class="nav-horizontal text-center">
   ...
   {{ Form::open(array('method' => 'POST','class' => 'form-horizontal','id' => 'defaultForm', 'url' => array('dresses/dresses/eidtar-clientewebpos/'.$cliente->id))) }}
                                 ...
                                 {{Form::hidden('redireccion', url()->previous(), array('class' => 'form-control','placeholder'=>'Event Date' ))}}
